      ...
      <div className="flex-1 flex flex-col relative min-w-0 bg-[#02040a]">
        ...
        <header className="h-14 border-b border-white/5 flex items-center px-4 gap-4 z-20 bg-[#05070a]/80 backdrop-blur-xl shrink-0">
          <div className="relative flex-1 max-w-sm">
            <input className="w-full bg-white/5 border border-white/10 rounded-lg py-1.5 pl-8 pr-4 text-[10px] outline-none" placeholder="搜尋全球數據..." />
          ...
          <aside className="w-[380px] z-10 p-4 flex flex-col gap-4 overflow-y-auto custom-scrollbar ml-auto pointer-events-auto h-full">
            <DashboardPanel title="即時情報流" tag="LIVE">
              <div className="space-y-3">
                <NewsCard source="ARJ News" title="【地緣觀察】台海區域電子作戰干擾強度增加，導航系統穩定性受阻。" time="1h" />
                <NewsCard source="WHSR News" title="【能源預報】中東原油產量調整協議達成，預期市場波動率將降至新低。" time="3h" />
              </div>
            </DashboardPanel>
              ...
              <div className="flex gap-4">
                <div className="flex-1 text-center">
                  ...
                  <div className="mt-4 space-y-1 text-[9px]">
                    <div className="flex justify-between"><span>Ukraine</span><span>23</span></div>
                    <div className="flex justify-between"><span>Gaza</span><span>239</span></div>
                  </div>
                </div>
